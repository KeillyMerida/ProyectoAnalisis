...
Partial Public Class DataSet2
    ...
    Partial Public Class USUARIODataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddUSUARIORow(ByVal ID_USUARIO As Decimal, ByVal NOMBRE As String, ByVal CORREO As String, ByVal ROL As String, ByVal USUARIO As String, ByVal CONTRA As String) As USUARIORow
            Dim rowUSUARIORow As USUARIORow = CType(Me.NewRow,USUARIORow)
            Dim columnValuesArray() As Object = New Object() {ID_USUARIO, NOMBRE, CORREO, ROL, USUARIO, CONTRA}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function FindByID_USUARIO(ByVal ID_USUARIO As Decimal) As USUARIORow
    ...
    Partial Public Class USUARIORow
        ...
        Public Property ID_USUARIO() As Decimal
            Get
                Return CType(Me(Me.tableUSUARIO.ID_USUARIOColumn),Decimal)
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsCONTRANull() As Boolean
            Return Me.IsNull(Me.tableUSUARIO.CONTRAColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetCONTRANull()
            Me(Me.tableUSUARIO.CONTRAColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DataSet2TableAdapters
    ...
    Partial Public Class LOGINTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""KEILLY"".""LOGIN"" (""USUARIO"", ""CONTRA"") VALUES (:USUARIO, :CONTRA)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Proyecto.My.MySettings.Default.ConexionDos
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT USUARIO, CONTRA FROM KEILLY.LOGIN"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet2.LOGINDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet2.LOGINDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet2.LOGINDataTable = New DataSet2.LOGINDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet2.LOGINDataTable) As Integer
    ...
    Partial Public Class USUARIOTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""KEILLY"".""USUARIO"" WHERE ((""ID_USUARIO"" = :Original_ID_USUARIO) AND ("& _ 
                ...
                " ((:IsNull_ROL = 1 AND ""ROL"" IS NULL) OR (""ROL"" = :Original_ROL)) AND ((:IsNull_"& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(param)
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "IsNull_CONTRA"
            param.DbType = Global.System.Data.DbType.Int32
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.Int32
            param.Size = 15
            param.IsNullable = true
            ...
            Me._adapter.DeleteCommand.Parameters.Add(param)
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "Original_CONTRA"
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.Varchar2
            param.Size = 15
            param.IsNullable = true
            param.SourceColumn = "CONTRA"
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""KEILLY"".""USUARIO"" (""ID_USUARIO"", ""NOMBRE"", ""CORREO"", ""ROL"", ""USUARIO"& _ 
                """, ""CONTRA"") VALUES (:ID_USUARIO, :NOMBRE, :CORREO, :ROL, :USUARIO, :CONTRA)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""KEILLY"".""USUARIO"" SET ""ID_USUARIO"" = :ID_USUARIO, ""NOMBRE"" = :NOMBRE, ""CO"& _ 
                "RREO"" = :CORREO, ""ROL"" = :ROL, ""USUARIO"" = :USUARIO, ""CONTRA"" = :CONTRA WHERE (("& _ 
                """ID_USUARIO"" = :Original_ID_USUARIO) AND ((:IsNull_NOMBRE = 1 AND ""NOMBRE"" IS NU"& _ 
                "LL) OR (""NOMBRE"" = :Original_NOMBRE)) AND ((:IsNull_CORREO = 1 AND ""CORREO"" IS N"& _ 
                "ULL) OR (""CORREO"" = :Original_CORREO)) AND ((:IsNull_ROL = 1 AND ""ROL"" IS NULL) "& _ 
                "OR (""ROL"" = :Original_ROL)) AND ((:IsNull_USUARIO = 1 AND ""USUARIO"" IS NULL) OR "& _ 
                "(""USUARIO"" = :Original_USUARIO)) AND ((:IsNull_CONTRA = 1 AND ""CONTRA"" IS NULL) "& _ 
                "OR (""CONTRA"" = :Original_CONTRA)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ID_USUARIO, NOMBRE, CORREO, ROL, USUARIO, CONTRA FROM KEILLY.USUARIO"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet2.USUARIODataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As DataSet2.USUARIODataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet2.USUARIODataTable = New DataSet2.USUARIODataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet2.USUARIODataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID_USUARIO As Decimal, ByVal Original_NOMBRE As String, ByVal Original_CORREO As String, ByVal Original_ROL As String, ByVal Original_USUARIO As String, ByVal Original_CONTRA As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_CONTRA,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal ID_USUARIO As Decimal, ByVal NOMBRE As String, ByVal CORREO As String, ByVal ROL As String, ByVal USUARIO As String, ByVal CONTRA As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID_USUARIO As Decimal, ByVal NOMBRE As String, ByVal CORREO As String, ByVal ROL As String, ByVal USUARIO As String, ByVal CONTRA As String, ByVal Original_ID_USUARIO As Decimal, ByVal Original_NOMBRE As String, ByVal Original_CORREO As String, ByVal Original_ROL As String, ByVal Original_USUARIO As String, ByVal Original_CONTRA As String) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(CONTRA,String)
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_CONTRA,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal NOMBRE As String, ByVal CORREO As String, ByVal ROL As String, ByVal USUARIO As String, ByVal CONTRA As String, ByVal Original_ID_USUARIO As Decimal, ByVal Original_NOMBRE As String, ByVal Original_CORREO As String, ByVal Original_ROL As String, ByVal Original_USUARIO As String, ByVal Original_CONTRA As String) As Integer
            Return Me.Update(Original_ID_USUARIO, NOMBRE, CORREO, ROL, USUARIO, CONTRA, Original_ID_USUARIO, Original_NOMBRE, Original_CORREO, Original_ROL, Original_USUARIO, Original_CONTRA)
        End Function
    End Class
